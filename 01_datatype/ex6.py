...
#  파이썬 문자열의 중요한 특징
# =========================================================
# 1. 문자열은 원본 불변이다 -> Immutable (문자열 연산 시 새로운 문자열이 만들어짐)
# 2. 문자열은 반복 가능하다 -> Iterable (반복처리 가능)
...
print(next(it))             # 인덱스 1을 반환하고, 다음 위치(인덱스 2)로 이동, 7번하면 오류 뜸
...
print(f"{s[:1]}학년 {s[1:2]}반 {s[3:4]}번")                  # ✅ "1학년 3반 1번" 출력